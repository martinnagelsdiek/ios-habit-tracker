...
```bash
git remote add encore encore://ios-habit-tracker-rnz2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ios-habit-tracker-rnz2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ios-habit-tracker-rnz2/settings/integrations/github)
